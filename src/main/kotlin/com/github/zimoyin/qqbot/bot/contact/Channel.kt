...
interface Channel : Contact {
     ...
     *
     */
    fun getGuildMembers(): Future<List<MemberBean>> {
...
class GuildRoles(val channel: Channel) {
     ...
     */
    @UntestedApi
    fun addGuildRoleMember(user: MemberBean, role: RoleBean): Future<RoleBean> {
        require(!channel.isChannel)
        return addGuildRoleMember(user.user!!.uid, role.id)
    }
     ...
     */
    @UntestedApi
    fun addGuildRoleMember(userID: MemberBean, roleID: String): Future<RoleBean> {
        require(!channel.isChannel)
        return addGuildRoleMember(userID.user!!.uid, roleID)
    }
     ...
     */
    @UntestedApi
    fun deleteGuildRoleMember(user: MemberBean, role: RoleBean): Future<RoleBean> {
        require(!channel.isChannel)
        return deleteGuildRoleMember(user.user!!.uid, role.id)
    }
     ...
     */
    @UntestedApi
    fun deleteGuildRoleMember(userID: MemberBean, roleID: String): Future<RoleBean> {
        require(!channel.isChannel)
        return deleteGuildRoleMember(userID.user!!.uid, roleID)
    }
...
class ChannelOperate(val channel: Channel) {
    ...
    fun deleteGuildMember(
        ...
        return HttpAPIClient.deleteSubChannelMember(channel, userID.user!!.uid, addBlacklist, deleteHistoryMsg)
    }
}
...
class Mute(val channel: Channel) {
    ...
    fun setChannelMuteMember(
        ...
        return setChannelMuteMember(user.user!!.uid, muteTimestamp, muteEndTimestamp)
    }
